...
x_position = 50 #(screen_width - window_width) // 2 - 500  # Center the window horizontally
y_position = 100 #(screen_height - window_height) // 2 - 500  # Center the window vertically
